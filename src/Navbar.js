...
function  Navbar(props){
  console.log("data token" ,props.loginStatus)
  console.log("props of cart data",props.cart)
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0">
      ...
      <button onClick= {search} class="btn btn-outline-success my-2 my-sm-0 btn-data" type="submit"><FontAwesomeIcon icon={faSearch} /></button>
    ...
    { props.loginStatus ?
          <div>
             <Link to="/cart" className="btn btn-warning my-2 my-sm-0 btn-data" type="submit"><FontAwesomeIcon icon={faShoppingCart} />
        <span class="price">
     ...
     <Link to="/myorders" ><button className="btn btn-info btn-data"  ><FontAwesomeIcon icon={faShoppingBag} /></button></Link>

     <button className="btn btn-danger btn-data" onClick={Logout}><FontAwesomeIcon icon={faSignOutAlt} /></button>
