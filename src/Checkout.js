...
function Checkout(props){
    console.log('props of shubham update counter',props)
    ...
    if(localStorage.token){
        ...
        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
            ...
            {props?.updatecounter>=2 ?
            <Link to={url+"/address"}>
            <li class="checkout-link nav-link">Address</li>
            </Link>:
            <li class="checkout-link nav-link  ">Address</li>
            }  
            {props?.updatecounter>=3 ?
            <Link to={url+"/payment"}>
            <li class="checkout-link nav-link" >Payment</li>
            </Link>:
            <li class="checkout-link nav-link ">Payment</li>
            }
            {props?.updatecounter>=4 ?
            <Link to={url+"/order"}>
            <li class="checkout-link nav-link" >Order</li>
            </Link>:
            <li class="checkout-link nav-link ">Order</li>
            }
        </div>
